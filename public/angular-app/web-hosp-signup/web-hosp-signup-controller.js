angular.module('bbApp')
    .controller('webhospsignupcontroller',webhospsignupcontroller);

function webhospsignupcontroller($location,$http) {
    var vm = this;
    document.getElementById('web_hosp_signup').style.visibility = 'hidden';
    angular.element(document).ready(function () {
        document.getElementById('web_hosp_signup').style.visibility = 'visible';
    });
    ...
    vm.signup = function(){
        ...
        if (vm.signupForm.$valid){
            if(vm.pass_inp == vm.cpass_inp){
                ...
                $http.post('/api/hospitals/signup',postdata)
